                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        <thead>
                                            ...
                                            $q=mysqli_query($connection,"SELECT * FROM maids  " )or die('Error223');
                                            $cnt=1;
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $maid_exp?> years </td>
                                                     ...
                                                     <td><a href="delete.php?id=<?php echo $id?>&&pat_name=<?php echo $maid_name?>" onclick="return confirm('Are you sure you want to delete');" class="badge badge-danger"><i class="mdi mdi-eye"></i> Delete</a> </td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>

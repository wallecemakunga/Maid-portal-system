...
if($pass==$old){
  if($new==$new2){
    ...
    <p><a href='navigation.php'><button class='button button--success' data-for='success'>Return to home Page</button></a></p>
    </div>
    </div>";
...
<div class="footer" style="margin-top: 70px;">
  <ul><center>Copyright &copy; 2024 MAID. All Rights Reserved</center></ul>
</div>
</body>
</html>